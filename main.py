...
def predict_health(input_data):
    """
    Dự đoán tình trạng sức khỏe dựa trên các chỉ số đầu vào và đưa ra lời khuyên.
    """
    # Tải mô hình và bộ chia tỷ lệ
    model, scaler = load_model_and_scaler()
    
    # Chuẩn bị dữ liệu đầu vào
    feature_columns = ['SGOT', 'SGPT', 'HDL-C', 'LDL-C', 'GGT', 
                       'Cre', 'Uric', 'HCT', 'MCV', 'LYM', 'BachCauMono']
    input_data['BachCauMono'] = input_data.pop('Bạch cầu Mono')  # Đổi tên cột
    ...
    # Tư vấn dựa trên kết quả và đặc trưng
